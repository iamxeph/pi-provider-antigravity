 ...
 * the backend accepts.
 *
 * Live A/B probe 2026-09-10 (gemini-3.8-flash-low, mitmdump :18080, see
 * captures/pi_probe_sentinel/): unsigned foreign functionCall as the pending step
 * of the current turn → 400 with the message above; the identical body with this
 * sentinel on that single part → 200.
 *
 * Applied to foreign calls only (see ADR-0007). A signature we *should* have had —
