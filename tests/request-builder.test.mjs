...
// requests. Live A/B probe (mitmdump :18080, gemini-3.8-flash-low, captures/
// pi_probe_sentinel/): unsigned pending functionCall → 400 with the message above; the
...
test("Seam 1: sentinel is Gemini-scoped, foreign-only and independent of the turn boundary", () => {
  ...
  // the backend's 400 still surfaces a lost/damaged signature instead of hiding it (ADR-0007).
